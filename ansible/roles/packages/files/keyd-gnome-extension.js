...
export default class KeydExtension extends Extension {
	enable() {
		...
		// system-modal-opened subscription removed — its handler raced with the
		// polkit prompt modal and silently broke pkexec dialogs (gdm-settings
		// Apply, polkit GUI prompts in general).
