...
def handle_msg(data, pbuffer, date, tags, displayed, highlight, prefix, message):
    ...
    # Focus check via xdotool removed — doesn't work on Wayland (xdotool is X11-only
    # and spams "window X has no pid associated" errors). Notifications fire on every
    # highlight/PM regardless of whether weechat has focus.
